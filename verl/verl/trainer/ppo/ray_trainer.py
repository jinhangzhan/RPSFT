...
class RayPPOTrainer:
    ...
    def fit(self):
        ...
        step_log_every = int(os.environ.get("VERL_STEP_LOG_EVERY", "0"))
        if step_log_every < 0:
            step_log_every = 0
        ...
        for epoch in range(current_epoch, self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    # Drop prompt-only tensors so rollout outputs can override them.
                ...
                self.global_steps += 1
                if step_log_every and (self.global_steps % step_log_every == 0 or self.global_steps == 1):
                    print(
                        f"[train] step {self.global_steps}/{self.total_training_steps} epoch={epoch}",
                        flush=True,
                    )
